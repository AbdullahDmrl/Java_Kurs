...
public class _01_JavaMap {
    public static void main(String[] args) {
        // Maps
        // Map ailesinden HashMap tanımlandı
        ...
        System.out.println("m.values() = " + m.values()); // değer listesi m.values() = [14, 12, 13]
        ...
        boolean buDegerVarMi = m.containsValue(12); // 12 degerei var mı ?
