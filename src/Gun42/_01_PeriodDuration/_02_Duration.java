package Gun42._01_PeriodDuration;
...
public class _02_Duration {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("fark.toSeconds() = " + fark.toSeconds()); // farkın toplam saniye hali
        System.out.println("*******");
        System.out.println("fark.toHoursPart() = " + fark.toHoursPart()); // farkın sadece tam saat parcasını verir
        System.out.println("fark.toMinutesPart() = " + fark.toMinutesPart()); // farkın dakika parcasını verir
        System.out.println("fark.toSecondsPart() = " + fark.toSecondsPart()); // farkın Saniye parcasını verir
